...
from Models.MapTopo.Cell import Cell
from Models.Rules import ConcatInt
from Models.Rules import DeconcatInt
from Models.MapTopo.River import River


class MapCarre:
    def __init__(self, size_map=0):
        self._size_map = size_map
        self.map = {ConcatInt(i, j): Cell.create_cell("None", i, j) for i in range(size_map) for j in range(size_map)}
    ...
    def create_river(self):
        ...
        temporary_x, temporary_y = DeconcatInt(key_source)
